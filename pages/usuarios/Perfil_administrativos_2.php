...
$apoderado = DBi::$mysqli->real_escape_string($_POST['apoderado']);


if ($_SESSION['user_rol'] == 7) { 
    $sql = "UPDATE login SET celular='$celular', email='$email', password='$password', apoderado='$apoderado' WHERE dni = '$dni'";
}else{
