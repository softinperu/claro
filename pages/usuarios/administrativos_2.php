                ...
                <div class="box box-success">
                    <div class="box-body box-profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label><font color="green">Rol de Usuario  :</font></label>
                                <select id="selectRol" onchange="myPillFilter(5, 'selectRol')" class="form-control select2" style="width: 100%;">                      
                                    <option value="">Seleccionar</option>
                                    <?php
                                    $sql = "select ID,rol_name from roles_usuarios ru where ID <> 7";
...
<script src="componentes/js/funciones_2.js"></script> 
<?php
