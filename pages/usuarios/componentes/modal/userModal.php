    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-edit"></i> Editar Administrativo</h4>
            </div>
                ...
                <div class="div-result">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="Info1">
                            <form action="../usuarios/componentes/php/editar_administrativos.php" method="POST" id="editUserForm" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label">: </label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="editDNI" placeholder="Usuario" name="editDNI" autocomplete="off" readonly>
                                    </div>
                                </div>   <!-- /form-group3-->     
