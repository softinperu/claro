                            ...
                            <form method="POST" action="Perfil_administrativos_2.php"  class="form-horizontal" id="perfilform" accept-charset="utf-8">
                                ...
                                <div class="form-group ">
                                    <?php if ($_SESSION['user_rol'] == 7) { ?>
                                        <label class="col-sm-3 control-label">Correo del Padre de Familia</label>
                                    <?php } else { ?>
                                ...
                                <?php if ($_SESSION['user_rol'] == 7) { ?>
                                    <div class="form-group ">
                                    <label class="col-sm-3 control-label">Nombre del Apoderado</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="apoderado" name="apoderado" value="<?php echo $_SESSION['apoderado']; ?>" placeholder="Ingrese datos del apoderado" autocomplete="off" required>
                                    </div>
                                </div> 
                                <?php } ?>
